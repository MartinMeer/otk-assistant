...
public class MTheradMainService extends MainService {
    ...
    public MTheradMainService(InputData inputData, FetchedDataProcessor fetchedDataProcessor, CalculatedDataProcessor calculatedDataProcessor, OutputDataMapper outputDataMapper) {
